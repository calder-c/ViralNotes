...
A C++ project aiming to recreate those viral note videos online that gain millions of views using SFML and midifile.
...
*midifile is already packaged with the repo but the program requires a SFML 3.x install to build*
